...
namespace Restless.Panama.Database.Tables
{
    ...
    /// and submssion documents. This is a readonly lookup table.
    /// </summary>
    public class DocumentTypeTable : Core.ApplicationTableLookupBase
    {
        ...
        public long GetDocTypeFromFileName(string filename)
        {
            if (!string.IsNullOrEmpty(filename))
            {
                ...
                string extension = System.IO.Path.GetExtension(filename)?.ToLower()[1..];
