...
namespace Restless.App.Panama.ViewModel
{
    ...
    public class MainWindowViewModel : WindowViewModel
    {
            ...
            :base(owner)
        {
            ...
            RawCommands.Add("About", OpenAbout);
            RawCommands.Add("Author", (o) => { CreateIf<AuthorViewModel>(); });
            RawCommands.Add("Close", CloseMainWindow);
            RawCommands.Add("CloseAll", CloseAllWorkspaces, CloseAllWorkspacesCanExecute);
            RawCommands.Add("Config", (o) => { CreateIf<ConfigViewModel>(); });
            RawCommands.Add("Credential", (o) => { CreateIf<CredentialViewModel>(); });
            RawCommands.Add("Link", (o) => { CreateIf<LinkViewModel>(); });
            RawCommands.Add("Note", (o) => { CreateIf<UserNoteViewModel>(); });
            RawCommands.Add("Publisher", (o) => { CreateIf<PublisherViewModel>(); });
            RawCommands.Add("Reference", (o) => { OpenHelper.OpenFile(AppInfo.ReferenceFileName); });
            RawCommands.Add("ResetWindow", RunResetWindowCommand);
            RawCommands.Add("Submission", (o) => { CreateIf<SubmissionViewModel>(); });
            RawCommands.Add("Save", Save);
            RawCommands.Add("Statistics", (o) => { CreateIf<StatisticsViewModel>(); });
            RawCommands.Add("Table", (o) => { CreateIf<TableViewModel>(); });
            RawCommands.Add("Tag", (o) => { CreateIf<TagViewModel>(); });
            RawCommands.Add("Title", (o) => { CreateIf<TitleViewModel>(); });
            RawCommands.Add("ToolConvert", (o) => { CreateIf<ToolConvertViewModel>(); }, CanRunToolConvertCommand);
            RawCommands.Add("ToolExport", (o) => { CreateIf<ToolExportViewModel>(); });
            RawCommands.Add("ToolMeta", (o) => { CreateIf<ToolMetaUpdateViewModel>(); });
            RawCommands.Add("ToolOrphan", (o) => { CreateIf<ToolOrphanViewModel>(); });
            RawCommands.Add("ToolScramble", (o) => { CreateIf<ToolScrambleViewModel>(); });
            RawCommands.Add("ToolSearch", (o) => { CreateIf<ToolSearchViewModel>(); });
            RawCommands.Add("ToolTitleList", (o) => { CreateIf<ToolTitleListViewModel>(); });

            VisualCommands.Add(new VisualCommandViewModel(Strings.CommandTitle, Strings.CommandTitleTooltip, RawCommands["Title"], ResourceHelper.Get("ImageTitle")));
            VisualCommands.Add(new VisualCommandViewModel(Strings.CommandPublisher, Strings.CommandPublisherTooltip, RawCommands["Publisher"], ResourceHelper.Get("ImagePublisher")));
            VisualCommands.Add(new VisualCommandViewModel(Strings.CommandSubmission, Strings.CommandSubmissionTooltip, RawCommands["Submission"], ResourceHelper.Get("ImageSubmission")));
